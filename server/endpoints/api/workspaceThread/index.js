console.log("[DEBUG] workspaceThread endpoint file loaded");
...
function apiWorkspaceThreadEndpoints(app) {
  ...
  // Before every app.use or app.post registration, add:
  // console.log("[DEBUG] Registering route: <route or middleware>");

  app.post(
    "/v1/workspace/:slug/thread/new",
    [validApiKey],
    async (request, response) => {
      console.log("[DEBUG] /v1/workspace/:slug/thread/new route hit");
      /*
  ...
  app.post(
    ...
    [validApiKey],
    async (request, response) => {
      console.log("[DEBUG] /v1/workspace/:slug/thread/:threadSlug/update route hit");
      /*
      #swagger.tags = ['Workspace Threads']
  ...
  app.delete(
    ...
    [validApiKey],
    async (request, response) => {
      console.log("[DEBUG] /v1/workspace/:slug/thread/:threadSlug route hit");
      /*
    #swagger.tags = ['Workspace Threads']
  ...
  app.get(
    ...
    [validApiKey],
    async (request, response) => {
      console.log("[DEBUG] /v1/workspace/:slug/thread/:threadSlug/chats route hit");
      /*
      #swagger.tags = ['Workspace Threads']
  ...
  app.post(
    ...
    [validApiKey],
    async (request, response) => {
      console.log("[DEBUG] /v1/workspace/:slug/thread/:threadSlug/chat route hit");
      /*
      #swagger.tags = ['Workspace Threads']
  ...
  app.post([
    ...
    [validApiKey],
    async (request, response) => {
      console.log("[DEBUG] HANDLER: workspaceThread/index.js /v1|/api/workspace/:slug/thread/:threadSlug/stream-chat called");
      /*
      #swagger.tags = ['Workspace Threads']
